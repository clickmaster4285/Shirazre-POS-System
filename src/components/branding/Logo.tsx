...
export default function Logo({
  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className ?? ''}`}>
      ...
      >
        <defs>
          <linearGradient id="shirazre-g" x1="0" y1="0" x2="1" y2="1">
        ...
        <rect x="16" y="16" width="224" height="224" rx="56" fill="url(#shirazre-g)" opacity="0.12" />

        <path
          d="M78 90l18 20 32-28 32 28 18-20 10 56H68l10-56z"
          fill="none"
          stroke="url(#shirazre-g)"
          strokeWidth="10"
          strokeLinejoin="round"
        />
        <path d="M78 146h100" stroke="url(#shirazre-g)" strokeWidth="10" strokeLinecap="round" />
      ...
      {showText ? (
        <span className={`font-serif font-bold tracking-wide ${textClassName ?? ''}`}>shirazre</span>
      ) : null}
    </div>
  );
}
